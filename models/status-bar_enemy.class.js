/**
 * Class representing the status bar for the enemy's health in the game.
 * This class manages the display of the enemy's health using different images based on the health percentage.
...
class StatusBarEnemy extends DrawableObjects {
    ...
    /**
     * Creates an instance of the StatusBarEnemy class, loading the images and setting the initial health percentage.
     * @constructor
     */
    constructor() {
        super();
    ...
    /**
     * Sets the health percentage of the enemy and updates the corresponding image.
